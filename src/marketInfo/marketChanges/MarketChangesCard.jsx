...
class MarketChangesCard extends Component {
    ...
    getOption() {
        ...
        variationData = this.props.variation
        let data = []
...
const mapStateToProps = state => {
    return {
        coinAmount: state.market.coinAmount,
